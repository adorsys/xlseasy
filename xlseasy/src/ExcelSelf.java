...
public class ExcelSelf extends Name {
	
	private static final String FILENAME = "workbookSelf.xls";
	...
	public void createExcel() {
		try {
			...
			for (int i = 0; i < 5; i++) {
				...
				for (int j = 1; j <= 3; j++) {
					sum += row2[j].getCell(i).getNumericCellValue();
				}				
				cell2[i].setCellValue(sum);
				sum = 0;
			}
